...
<title><? echo $tituloPagina ?></title>
	...
	<body id="PaginaInicial" class="bg1">
		<?php include 'assets/header.php'; ?>
		
		<?php include 'assets/footer.php'; ?>
		<div id="Load">
			<img src="<? echo $url ?>imagens/bg1.jpeg" />
			<img src="<? echo $url ?>imagens/bg2.jpeg" />
			<img src="<? echo $url ?>imagens/bg3.jpeg" />
			<img src="<? echo $url ?>imagens/bg4.jpeg" />
		</div>
	</body>
</html>